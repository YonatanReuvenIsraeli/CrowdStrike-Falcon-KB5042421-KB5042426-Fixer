...
:"CrowdStrikeCheck"
echo.
echo Checking CrowdStrike Falcon status on "%DriveLetterWindows%.
if exist "%DriveLetterWindows%\Windows\System32\drivers\CrowdStrike" goto "BugCheck"
echo CrowdStrike Falcon not installed on "%DriveLetterWindows%! Press any key to close this batch file.
pause > nul 2>&1
goto "Close"

:"BugCheck"
if exist "%DriveLetterWindows%\Windows\System32\drivers\CrowdStrike\C-00000291*.sys" goto "CrowdStrike"
echo CrowdStrike Falcon installed on "%DriveLetterWindows% but no problems found! Press any key to close this batch file.
pause > nul 2>&1
goto "Close"

:CrowdStrike
echo CrowdStrike Falcon installed on "%DriveLetterWindows%" and may have problems!
set CrowdStrike=
